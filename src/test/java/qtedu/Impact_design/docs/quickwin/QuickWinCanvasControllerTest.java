...
class QuickWinCanvasControllerTest extends RestDocsTestSupport {
        ...
        mockMvc.perform(get("/api/quick-win-canvas"))
                ...
                .andDo(document("quick-win-canvas/get",
                        responseFields(
                                ...
                                fieldWithPath("data.taskName").description("과업 이름"),
                                fieldWithPath("data.taskDescription").description("과업 설명"),
                                fieldWithPath("data.crisisSignal").description("위기 신호"),
                                fieldWithPath("data.painTouchPoint").description("고통 접점"),
                                ...
                                fieldWithPath("data.taskInputs[].resourceName").description("자원 이름"),
        ...
        mockMvc.perform(post("/api/quick-win-canvas")
                ...
                .andDo(document("quick-win-canvas/save",
                        requestFields(
                                ...
                                fieldWithPath("taskName").description("과업 이름"),
                                fieldWithPath("taskDescription").description("과업 설명"),
                                fieldWithPath("crisisSignal").description("위기 신호"),
                                fieldWithPath("painTouchPoint").description("고통 접점"),
                                fieldWithPath("taskInputs[]").description("투입 자원 목록"),
                                fieldWithPath("taskInputs[].inputId").description("투입 ID (수정 시)"),
                                fieldWithPath("taskInputs[].resourceName").description("자원 이름"),
                                ...
                                fieldWithPath("taskActivities[].processStep").description("프로세스 단계"),
                                fieldWithPath("taskActivities[].activityContent").description("활동 내용"),
                                ...
                                fieldWithPath("teamwork.activityTeamwork").description("팀워크 활동"),
                                fieldWithPath("teamwork.workType").description("작업 유형"),
    ...
    void submitQuickWinCanvas() throws Exception {
        authenticateAs(1L);
        given(quickWinCanvasService.submitQuickWinCanvas(anyLong()))
