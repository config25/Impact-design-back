...
class GameServiceTest {
    ...
    @Mock
    private TbGameRepository tbGameRepository;
    @Mock
    ...
    void getUserStep() {
        given(tbGameRepository.findStepByUserId(1L)).willReturn("step3");
    ...
    class GetDashboard {
        ...
        void returnsDashboard() throws Exception {
            ...
            given(tbGameRepository.findByUserId(1L)).willReturn(Optional.of(game));
            given(teamUserRepository.findTeamNameByUserId(1L)).willReturn(Optional.of("팀1"));
            given(userinfoRepository.findByUserId(1L)).willReturn(Optional.of(user));
        ...
        void throwsWhenGameNotFound() {
            given(tbGameRepository.findByUserId(1L)).willReturn(Optional.empty());
        ...
        void throwsWhenTeamNotFound() {
            ...
            given(tbGameRepository.findByUserId(1L)).willReturn(Optional.of(game));
            given(teamUserRepository.findTeamNameByUserId(1L)).willReturn(Optional.empty());
    ...
    private void setFileBaseUrl(String url) throws Exception {
        Field field = GameService.class.getDeclaredField("fileBaseUrl");
        field.setAccessible(true);
        field.set(gameService, url);
    }
}
