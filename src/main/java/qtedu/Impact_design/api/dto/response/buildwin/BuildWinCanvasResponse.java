package qtedu.Impact_design.api.dto.response.buildwin;
...
@Getter
@Builder
public class BuildWinCanvasResponse {
    ...
    public static BuildWinCanvasResponse from(WinCanvasModel canvas,
